...
const translations = {
  ...
  "Рассказы": "Stories",
  "Лор, досье персонажей, история мира и рассказы.": "Lore, character dossiers, world history, and stories.",
  ...
  "Введите ключевое слово или выберите тег.": "Enter a keyword or choose a tag.",
  ...
  "Этот портал собирает знания об игре в одном месте: новости, гайды, справочные материалы, лор, видео, турниры и ссылки сообщества.": "This portal brings game knowledge together in one place: news, guides, reference materials, lore, videos, tournaments, and community links.",
